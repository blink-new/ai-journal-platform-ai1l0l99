...
import type { Post, AIFeedbackMode } from '../types'
...
export const WritingInterface = ({ post, onSave, onBack }: WritingInterfaceProps) => {
  ...
  }, [title, content, selectedMood, tags, isFavorite, wordCount, readingTime, aiProfessionalFeedback, aiHumorousFeedback, post?.id, createPost, updatePost, onSave, generateAIFeedback])
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button onClick={() => handleSave(true)} className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600">
